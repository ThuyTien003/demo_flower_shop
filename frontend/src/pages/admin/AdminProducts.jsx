    ...
    { title: 'Thao tác', style: { width: 200 }, render: (p) => (
      <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
        {editingId === p.product_id ? (
          ...
          <button title="Sửa" onClick={() => startEdit(p)} style={styles.iconBtn}><FaEdit /></button>
        )}
        <button title="Xóa" style={{ ...styles.iconBtn, color: '#b91c1c' }} onClick={() => onDelete(p)}><FaTrash /></button>
      </div>
    ) },
